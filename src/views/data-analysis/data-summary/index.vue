...
import ChartStatistic from "./components/ChartStatistic.vue";
    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        <div class="user-detail-header">
          <div>
            <el-button
              :type="tab_index == 0 ? 'warning' : ''"
              @click="handleButtonActive(0)"
              >数据</el-button
            >
            <el-button
              :type="tab_index == 1 ? 'warning' : ''"
              @click="handleButtonActive(1)"
              >图表</el-button
            >
          </div>
        </div>
        <Statistic v-if="tab_index == 0" />
        <ChartStatistic v-if="tab_index == 1" />
      </el-col>
    </el-row>
  </div>
</template>
