    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        <el-card style="margin-top: 20px">
          <el-table
            v-loading="loading"
            :data="chargeWithdrawReportList"
            style="width: 100%"
          >
            <el-table-column
              label="时间"
              align="left"
              prop="charge_withdraw_date_time"
              width="120"
            >
            ...
            <el-table-column
              label="平台充提差"
              align="left"
              prop="charge_withdraw_platform_difference"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="充提差占今日充值今天百分比"
              align="left"
              prop="charge_withdraw_recharge_today_rate"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="充值笔数"
              align="left"
              prop="charge_withdraw_recharge_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="充值人数"
              align="left"
              prop="charge_withdraw_recharge_number"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="充值成功笔数"
              align="left"
              prop="charge_withdraw_success_recharge_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="充值成功率"
              align="left"
              prop="charge_withdraw_success_recharge_rate"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="首充人数"
              align="left"
              prop="charge_withdraw_first_charge_number"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="复充新用户人数"
              align="left"
              prop="charge_withdraw_new_user_recharge_count"
              width="160"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="首充金额"
              align="left"
              prop="charge_withdraw_first_charge_amount"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="新用户首日充值总金额"
              align="left"
              prop="charge_withdraw_new_user_recharge_amount"
              width="170"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="复充人数"
              align="left"
              prop="charge_withdraw_refill_user_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="复充笔数"
              align="left"
              prop="charge_withdraw_refill_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="复充金额"
              align="left"
              prop="charge_withdraw_recharge_amount"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="复充金额占比"
              align="left"
              prop="charge_withdraw_recharge_amount_proportion"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="注册人数"
              align="left"
              prop="charge_withdraw_registrant_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="新用户付费率"
              align="left"
              prop="charge_withdraw_new_user_payment_rate"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="申请提现笔数"
              align="left"
              prop="charge_withdraw_cash_withdrawal_app_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="提现成功笔数"
              align="left"
              prop="charge_withdraw_success_withdraw_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="提现成功金额"
              align="left"
              prop="charge_withdraw_success_withdraw_amount"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="代理提现金额"
              align="left"
              prop="charge_withdraw_agent_withdraw_amount"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="手动加金笔数"
              align="left"
              prop="charge_withdraw_gold_count"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="手动加金金额"
              align="left"
              prop="charge_withdraw_manual_addition_amount"
              width="120"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="手动确认充值笔数"
              align="left"
              prop="charge_withdraw_manual_recharge_count"
              width="160"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="手动确认充值金额"
              align="left"
              prop="charge_withdraw_manual_top_amount"
              width="160"
            >
              <template #default="scope">
            ...
            <el-table-column
              label="提现成功不打款金额"
              align="left"
              prop="charge_withdraw_none_withdraw_amount"
              width="160"
            >
              <template #default="scope">
