...
import { addRebateConfiguration } from '@/api/event-management';
...
const handleAdd = async ()=>{
    addRebateConfiguration(user.token, formData.value);
}
</script>
    ...
    <div class="app-container">
        ...
        <el-card style="margin-top: 10px;">
           ...
           <el-row>
                ...
                <el-col :span="18" class ="edit-item-right-bg"><el-input v-model="formData.method_name" type="password" placeholder="请输入方案名称" style="pediting: 0;"></el-input> </el-col>
           </el-row>            
           <el-row>
