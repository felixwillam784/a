  ...
  <div class="app-container">
    ...
    <div v-if="tab_index == 1" class="search">
      <el-form class="left_position" style="display: flex">
        <el-form-item label="VIP等级" style="display: flex">
          ...
          <el-input
            v-model="formData.vip_level_number"
        ...
        <el-form-item label="领取VIP奖励人数" style="display: flex">
          ...
          <el-input
            v-model="formData.vip_reward_receive_number"
            placeholder="请输入人数"
            style="width: 200px"
          />
        </el-form-item>
        ...
        <el-form-item label="BUFF数量" style="display: flex">
          ...
          <el-input
            v-model="formData.buff_quantity_number"
            placeholder="请输入BUFF数量"
            style="width: 200px"
          />
        </el-form-item>
      </el-form>
      ...
      >
        <div style="display: flex">
          <el-form-item label="奖金金额" style="display: flex">
            ...
            <el-input
              v-model="formData.bonus_amount_number"
              placeholder="请输入奖金金额"
              style="width: 200px"
            />
          </el-form-item>
          ...
          <el-form-item label="真金金额" style="display: flex">
            ...
            <el-input
              v-model="formData.real_money_amount_number"
              placeholder="请输入真金金额"
              style="width: 200px"
            />
          </el-form-item>
          ...
          <el-form-item label="道具数量" style="display: flex">
            ...
            <el-input
              v-model="formData.props_amount_number"
              placeholder="请输入道具数量"
              style="width: 200px"
            />
          </el-form-item>
    ...
    <el-card>
      <el-table v-if="tab_index == 0" style="width: 100%" :data="upgrade_bonus_list">
        ...
        <el-table-column label="关联奖金ID" align="center">
          <template #header>
            <span class="pink_t_header"> 关联奖金ID </span>
          </template>
      ...
      >
        ...
        <el-table-column
          ...
          label="等级内账号数"
          align="center"
          prop="vip_level_count"
        />
        <el-table-column
          sortable
          label="领取人数"
          align="center"
          prop="vip_bonus_recevier_count"
        />
        <el-table-column
          sortable
          label="真金金额"
          align="center"
          prop="real_money_amount"
        />
        ...
        <div style="width: 80%">
          ...
          >
            ...
            <div
              ...
              "
            >
              <el-button v-if="index != 0" @click="delete_row('prop', index)">
                -
              </el-button>
              <el-button
          ...
          >
            ...
            >
              ...
              <p style="width: 60%; margin-left: 30px">道具数量</p>
              <el-input
                v-model="new_prop.amount"
                :value="new_prop.amount === -1 ? '' : new_prop.amount"
                style="margin-left: 0px"
                placeholder="请输入奖励数量"
              />
              <p style="width: 60%; margin-left: 30px">道具权重</p>
              <el-input
                v-model="new_prop.weight"
                :value="new_prop.weight === -1 ? '' : new_prop.weight"
                placeholder="请输入奖励权重"
              />
            </div>
            <div
        ...
        <div style="width: 80%">
          ...
          >
            ...
            <div
              ...
              "
            >
              <el-button v-if="index != 0" @click="delete_row('buff', index)">
                -
              </el-button>
              <el-button
          ...
          >
            ...
            >
              ...
              <p style="width: 60%; margin-left: 30px">Buff数量</p>
              <el-input
                v-model="new_buff.amount"
                :value="new_buff.amount === -1 ? '' : new_buff.amount"
                style="margin-left: 0px"
                placeholder="请输入奖励数量"
              />
              <p style="width: 60%; margin-left: 30px">Buff权重</p>
              <el-input
                v-model="new_buff.weight"
                :value="new_buff.weight === -1 ? '' : new_buff.weight"
                placeholder="请输入奖励权重"
              />
            </div>
            <div
        ...
        <div style="width: 80%">
          ...
          >
            ...
            <div
              ...
              "
            >
              <el-button v-if="index != 0" @click="delete_row('relation', index)">
                -
              </el-button>
              <el-button
          ...
          >
            ...
            >
              ...
              <el-input
                v-model="new_relation.weight"
                :value="new_relation.weight === -1 ? '' : new_relation.weight"
                placeholder="请输入奖励权重"
              />
            </div>
            <div
        ...
        <div style="width: 80%">
          ...
          >
            ...
            >
              ...
              <el-input
                v-model="item.code_magnification"
                style="margin-left: 0px"
                placeholder="请输入打码倍率"
              />
            ...
            <div
              ...
              "
            >
              <el-button v-if="index != 0" @click="delete_row('real', index)">
                -
              </el-button>
              <el-button
          ...
          >
            ...
            >
              <el-input
                v-model="new_real.amount"
                :value="new_real.amount === -1 ? '' : new_real.amount"
                placeholder="请输入真金"
              />
              <p style="width: 40%; margin-left: 30px">打码倍率</p>
              <el-input
                v-model="new_real.code_magnification"
                :value="
                  new_real.code_magnification === -1 ? '' : new_real.code_magnification
                "
                style="margin-left: 0px"
                placeholder="请输入打码倍率"
              />
              <p style="width: 40%; margin-left: 30px">真金权重</p>
              <el-input
                v-model="new_real.weight"
                :value="new_real.weight === -1 ? '' : new_real.weight"
                placeholder="请输入奖励权重"
              />
            </div>
            <div
