    ...
    <el-row :gutter="20">
      <el-col :span="24" :sx="24">
        <div class="flex justify-end items-center">
          <el-button @click="BannerDlgVisible = true">新增广告图配置</el-button>
          ...
          >
            ...
            >
              <template #default="scope">
                {{ FeedbackOption.find(item => item.value === scope.row.click_feedback)?.label }}
              </template>
            </el-table-column>
            <el-table-column
              label="内容"
            ...
            >
              <template #default="scope">
                <el-button @click="handleBannerDelete">详情</el-button>
    ...
    >
      ...
      >
        ...
        <el-form-item label="广告图排序">
          <el-input v-model="formData.sort" placeholder="请输入广告图排序"/>
        </el-form-item>
        ...
        <el-form-item label="内容">
          <el-input v-model="formData.content" type="textarea" placeholder="请输入广告图排序"/>
        </el-form-item>
        ...
        <el-form-item label="参与活动广告图消失后替换的广告图ID">
          <el-input v-model="formData.replace_id" placeholder="请输入关联的广告图ID"/>
        </el-form-item>
...
const handleBannerDetail = async (id: number) => {
  loading.value = true;
  await banner.dispatchBannerDetail({id});
  if (!success.value) 
    ElMessage.error(errMsg.value);
  else {
