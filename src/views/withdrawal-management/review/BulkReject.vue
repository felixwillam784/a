...
<template>
    <div class="app-container">
        <div class="user-detail-header">
            ...
            <el-button type="warning" style="margin-left: auto;">批量拒绝</el-button>
        </div>
        <el-row :gutter="20">
                ...
                <el-card style="margin-top: 20px;">
                    <el-table v-loading="loading" :data="withdrawalReviewList" style="width: 100%;">
                        ...
                        <el-table-column label="风控提示" align="center" prop="risk_control_hint">
                            <template #default="scope">
                                <Font color="red"
                                    v-if="scope.row.risk_control_hint == '已风控' || scope.row.risk_control_hint == '一级风控'">{{
