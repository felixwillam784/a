...
const rules = ref<FormRules<GetBan>>({
  ban_remark: [{ required: true, message: "请输入解封备注。", trigger: "blur" }],
});
...
<template>
  <div class="app-container">
        ...
        <el-card>
          <el-table v-loading="loading" :data="blackList" style="width: 100%">
            ...
            <el-table-column align="center" fixed="right" width="160">
              <template #default="scope">
                <el-button type="danger" link @click="detailBlackDialog(scope.row)">
                  详情
                </el-button>
                <el-button type="success" link @click="removeBlackDialog(scope.row)">
                  移除黑名单
                </el-button>
              </template>
            </el-table-column>
    ...
    <el-dialog
      title="移除黑名单"
      v-model="blackRemoveDialogVisible"
      width="600px"
      append-to-body
      @close="closeDialog"
    >
    ...
    <el-dialog
      title="黑名单详情"
      v-model="blackDetailDialogVisible"
      width="600px"
      append-to-body
      @close="closeDialog"
    >
