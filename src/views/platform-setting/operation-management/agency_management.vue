    ...
    <div class="app-container">
        ...
        <el-card class="config-table">
            <el-table v-loading="loading" :data="bankList" style="width: 100%;">
                <el-table-column label="代理层级" align="left" prop="level" />
                <el-table-column label="返利比例" align="left" prop="ratio" >
                    <template #default="scope">
                        
                        <el-input v-model="scope.row.ratio" placeholder="" style = "width: 120px;" />
                    </template>
                </el-table-column>
            </el-table>
        </el-card>
