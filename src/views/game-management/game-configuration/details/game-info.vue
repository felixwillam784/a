            ...
            <el-row :gutter="20" >
                <el-col :span="8">
                    <el-form-item label="限制国家:">
                        <el-text class="restricted-country" v-for="(item, index) in gameInformation.restricted_country" :key = "index">{{ item }}</el-text>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20" >
                ...
                <el-col :span="8">
                    <el-form-item label="开启试玩:">
                        <el-switch v-model="gameInformation.game_trial_start" style="margin-right: 10px;" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <el-form >
                        <el-form-item label="游戏状态:">
                            <el-select v-model="gameInformation.game_state" class="m-2" placeholder="Select" size="large">
                                <el-option
            ...
            <el-row :gutter="20" >
                <el-col>
                    <div v-if = "isTabPanelShow == true" class="tab-container">
                        <div>
                            <el-button class="tab-button" :type="isClassic == true ? 'warning' : ''"
                                @click="handleSelectTab('Classic')" style="margin-left: 20px;">Classic</el-button>
                            <el-button class="tab-button" :type="isEvoPlay == true ? 'warning' : ''"
                                @click="handleSelectTab('EvoPlay')" style="margin-left: 20px;">EvoPlay</el-button>
                            <el-button class="tab-button" :type="isClub == true ? 'warning' : ''"
                                @click="handleSelectTab('Club')" style="margin-left: 20px;">Club</el-button>
                            <el-button class="tab-button" :type="isAAA == true ? 'warning' : ''"
                                @click="handleSelectTab('AAA')" style="margin-left: 20px;">AAA</el-button>
                            <el-button class="tab-button" :type="isBBB == true ? 'warning' : ''"
                                @click="handleSelectTab('BBB')" style="margin-left: 20px;">BBB</el-button>
                            <el-button class="tab-button" :type="isCCC == true ? 'warning' : ''"
                                @click="handleSelectTab('CCC')" style="margin-left: 20px;">CCC</el-button>
                        </div>
                        <div class="add-tag-btn">
                            <el-button class="tab-button" :type="isTabPanelShow == true ? 'warning' : ''"
                                @click="handleAddTab()" style="margin-left: 20px;">添加标签</el-button>
                        </div>
