...
<template>
  <el-table
    ...
    class="mt-2"
  >
    <el-table-column label="身份信息（CPF）号" align="center" prop="item_1">
    ...
    <el-table-column label="同身份信息下账户数量" align="center" prop="item_4">
      <template #default="scope">
  ...
  <el-dialog title="设备ID关联账号" v-model="riskControlDetailDialogVisible">
    <el-row class="bg-neutral-100 align-center mb-1 h-12">
      <el-col :span="6" class="ps-4">风控身份信息</el-col>
      <el-col :span="18"> 1366666666666GFD </el-col>
    </el-row>
