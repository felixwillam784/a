...
<template>
  <el-table
    ...
    class="mt-2"
  >
    <el-table-column label="IP地址" align="center" prop="item_1">
    ...
    <el-table-column label="同IP下注册账户数量" align="center" prop="item_4">
      <template #default="scope">
        <p>{{ scope.row.item_4 }}</p>
      </template>
    </el-table-column>
    <el-table-column label="同IP下登录账户数量" align="center" prop="item_4">
      <template #default="scope">
        <p>{{ scope.row.item_4 }}</p>
      </template>
    </el-table-column>
  ...
  <el-dialog title="IP关联账号" v-model="riskControlDetailDialogVisible">
    <el-row class="bg-neutral-100 align-center mb-1 h-12">
      <el-col :span="6" class="ps-4">风控IP地址</el-col>
      <el-col :span="18"> 139.162.1.3 </el-col>
    </el-row>
