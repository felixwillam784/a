...
const rechargeRecordList = ref([
    {
        rechargeTime: "2023-07-01 15:23:00",
        gameOrderNumber: "ABCDEFGHIJKMKSLOOPGGERRERE",
    ...
    <div class="app-container">
        ...
        <el-card>
            ...
            <el-table v-loading="loading" :data="rechargeRecordList" style="width: 100%; margin-top: 10px;">
                ...
                <el-table-column label="时间" align="center" prop="rechargeTime" width="200" />
                <el-table-column label="游戏订单号" align="center" prop="gameOrderNumber" />
                ...
                <el-table-column label="订单状态" align="center" prop="orderStatus">                 
                    <template #default="scope">
                        ...
                        <Font color="red" v-else-if="scope.row.orderStatus == 1">未支付</Font>
