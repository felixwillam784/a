...
const formData = ref<any>({
    winningDate: moment().tz("Asia/Hong_Kong").format("YYYY-MM-DD"),
    pageNum: 1,
    pageSize: 20,
})
    ...
    <div class="app-container">
        ...
        <el-card>
                ...
                <el-col :span="16">
                    <el-form :model="formData" :inline="true" label-width="120">
                        <el-form-item label="中奖日期:">
                            <el-date-picker v-model="formData.winningDate" type="date" placeholder="Pick a Date"
            ...
            <el-table v-loading="loading" :data="bettingRecordList" style="width: 100%; margin-top: 10px;">
                ...
                <el-table-column label="中奖金额" align="center" prop="winningAmount">
                    <template #default="scope">
                        <p>$ {{ scope.row.winningAmount.toFixed(2) }}</p>
                    </template>
                </el-table-column>
                <el-table-column label="中奖倍率" align="center" prop="winningRate">                    
                    <template #default="scope">
                        <p>{{ scope.row.winningRate.toFixed(2) }}</p>
                    </template>
                </el-table-column>
