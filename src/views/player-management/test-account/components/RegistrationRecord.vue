    ...
    <el-col :span="24" :xs="24">
        ...
        <el-row style="align-items: center">
          <el-col :md="12" :lg="24" class="agency-management-list-form">
            <el-form
              ...
              label-position="left"
            >
              <el-form-item label="登录平台" prop="email_address">
                <el-select
              ...
              <el-form-item label="归属地" prop="user_id">
                <el-input
                  v-model="formData.user_id"
                  placeholder="请输入归属地"
                  style="width: 252px"
              ...
              <el-form-item label="登录设备" prop="user_id">
                <el-input
                  v-model="formData.user_id"
                  placeholder="请输入登录设备"
                  style="width: 252px"
      ...
      <el-card style="margin-top: 20px">
        <el-table v-loading="loading" :data="agencyList" style="width: 100%">
          <el-table-column label="登录时间" align="center" prop="item_1" width="160">
          ...
          <el-table-column label="登录IP" align="center" prop="item_2">
            <template #default="scope">
              <p>{{ scope.row.item_2 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="归属地" align="center" prop="item_3">
            <template #default="scope">
              <p>{{ scope.row.item_3 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="登录平台" align="center" prop="item_4">
            <template #default="scope">
              <p>{{ scope.row.item_4 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="登录设备" align="center" prop="item_5">
            <template #default="scope">
              <p>{{ scope.row.item_5 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="ISP" align="center" prop="item_6">
            <template #default="scope">
              <p>{{ scope.row.item_6 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="设备号" align="center" prop="item_7">
            <template #default="scope">
