    ...
    <el-col :span="24" :xs="24">
        ...
        <el-row style="align-items: center">
          <el-col :md="12" :lg="24" class="agency-management-list-form">
            <el-form
              ...
              label-position="left"
            >
              <el-form-item label="事件类型" prop="email_address">
                <el-select
                  v-model="formData.user_id"
                  placeholder="请选择时事件类型"
                  style="min-width: 252px"
                >
                </el-select>
              </el-form-item>
              <el-form-item label="货币类型" prop="email_address">
                <el-select
                  v-model="formData.user_id"
                  placeholder="请选择货币类型"
                  style="min-width: 252px"
              ...
              <el-form-item label="变动金额" prop="invitee_total_number">
                <el-input
            ...
            <el-form
              ...
              label-position="left"
            >
              <el-form-item label="记录ID" prop="user_id">
                <el-input
                  v-model="formData.user_id"
                  placeholder="请输入记录ID"
                  style="width: 252px"
      ...
      <el-card style="margin-top: 20px">
        <el-table v-loading="loading" :data="agencyList" style="width: 100%">
          ...
          <el-table-column label="时间类型" align="center" prop="item_2">
            <template #default="scope">
              <p>{{ scope.row.item_2 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="详细内容" align="center" prop="item_3">
            <template #default="scope">
          ...
          <el-table-column label="变动金额" align="center" prop="item_5">
            <template #default="scope">
              <p>{{ scope.row.item_5 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="变动前金额" align="center" prop="item_6">
            <template #default="scope">
              <p>{{ scope.row.item_6 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="变动后金额" align="center" prop="item_7">
            <template #default="scope">
              <p>{{ scope.row.item_7 }}</p>
            </template>
          </el-table-column>
          <el-table-column label="记录ID" align="center" prop="item_8">
            <template #default="scope">
